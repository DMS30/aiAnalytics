...
typedef void (^PHGMiddlewareNext)(aiContext *_Nullable newContext);

@protocol aiMiddleware
@required
...
- (void)context:(aiContext *_Nonnull)context next:(PHGMiddlewareNext _Nonnull)next;

@end

typedef void (^PHGMiddlewareBlock)(aiContext *_Nonnull context, PHGMiddlewareNext _Nonnull next);


@interface PHGBlockMiddleware : NSObject <aiMiddleware>
...
typedef void (^RunMiddlewaresCallback)(BOOL earlyExit, NSArray<id<aiMiddleware>> *_Nonnull remainingMiddlewares);
...
@property (nonnull, nonatomic, readonly) NSArray<id<aiMiddleware>> *middlewares;

- (void)run:(aiContext *_Nonnull)context callback:(RunMiddlewaresCallback _Nullable)callback;

- (instancetype _Nonnull)initWithMiddlewares:(NSArray<id<aiMiddleware>> *_Nonnull)middlewares;
