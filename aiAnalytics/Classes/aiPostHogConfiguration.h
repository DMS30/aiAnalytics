 ...
 */
@interface aiPostHogConfiguration : NSObject
 ...
 * Changing the value of this property after initializing the client will have no effect.
 * If set to `YES` (default), `aiHog` will automatically call `reloadFeatureFlags` during initialization.
 ...
 */
@property (nonatomic, strong, nullable) NSArray<id<aiMiddleware>> *middlewares;
