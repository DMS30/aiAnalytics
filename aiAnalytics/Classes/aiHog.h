...
#import "aiPostHogConfiguration.h"
 ...
 */
@class aiPostHogConfiguration;


@interface aiHog : NSObject
 ...
 */
@property (nonatomic, strong, readonly) aiPostHogConfiguration *configuration;
...
- (aiPostHogConfiguration *)configuration;
